...
function M.live(theme)
   ...
   label.welcome:set_text("Welcome to AZLA")
   label.welcome:set_markup("<span size='" .. font.welcome_size .. "' foreground='" .. theme.label_welcome .. "'>" .. label.welcome.label .. "</span>"  )
   ...
   label.theme:set_markup("<span size='" .. font.welcome_size .. "' foreground='" .. theme.label_fg .. "'>" .. label.theme.label .. "</span>"  )
    
   label.theme_apply:set_text("Applied new settings. Please restart the app")
   label.theme_apply:set_markup("<span size='" .. font.fg_size .. "' foreground='" .. theme.label_correct .. "'>" .. label.theme_apply.label .. "</span>"  )
   
   for key, value in pairs(label.theme_restore) do
        label.theme_restore[key]:set_text("Restored to default settings")
        label.theme_restore[key]:set_markup("<span size='" .. font.fg_size .. "' foreground='" .. theme.label_fg .. "'>" .. label.theme_restore[key].label .. "</span>"  )
   end
   ...
   for key, value in pairs(theme) do
        ...
        array.theme_labels_setting[key]:set_markup("<span foreground='" .. theme.label_fg .. "'size='" .. font.fg_size .. "'>" .. array.theme_labels_setting[key].label .. "</span>")
   end
   ...
   treeView.tree = array.set_theme(treeView.tree, {{size = font.fg_size / 1000, color = theme.label_word, border_color = theme.label_fg}})
