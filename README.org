...
#+begin_src sh
# You can also use pacman etc or if you use ubuntu or any oother distro the package name can be diffrent
...
This is some Nouns in azerbajani
...
This is some common phrases in azerbajani
