...
label.setting:set_markup("<span size='" .. font.welcome_size .. "' foreground='" .. theme.label_fg .. "'>" .. label.setting.label .. "</span>"  )
label.theme_nochange:set_markup("<span size='" .. font.welcome_size .. "' foreground='" .. theme.label_incorrect .. "'>" .. label.theme_nochange.label .. "</span>"  )
...
function label.end_create()
    ...
    -- Make end Labels
    wg.labelEnd = question.create_label({
    {attributes = "foreground='" .. theme.label_fg .. "'size='" .. font.fg_size .. "'", 
    text = "You reached the last question"}
    })
