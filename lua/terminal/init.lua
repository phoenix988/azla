...
function M.terminal_init()
   ...
   function welcome()
      print(
         colors.blue
         .. "Welcome to my script that will help you practice Azerbaijani words and sentences"
   ...
   while run do
      ...
      getResult = questionMainModule.get_result
      ...
      result_table[session] = get_result()
   ...
   -- working on a function to keep track of all the sessions
   -- with there own result
   --for i = 1, session do
   --   print("Your correct answers for session" .. " ".. i)
   --   for key, value in pairs(result_table[i]) do
   --      if key == "correct" then
   --         print(colors.green .. "Correct: " .. value)
   --      elseif key == "incorrect" then
   --         print(colors.red .. "Incorrect: " .. value)
   --      end
   --   end
   --end
