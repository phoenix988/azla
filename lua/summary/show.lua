...
-- Function to show the summary page in the end 
function show.summary(question, grid, grid2, theme)
    ...
    if question.label_correct ~= nil then
        ...
        for key, value in pairs(question.label_correct) do
            ...
            if type(key) == "number" then
                ...
                if value ~= nil then
                    ...
                    label_correct[key]:set_markup(
                        "<span foreground='"
                        .. theme.label_correct
                        .. "' size='"
                        .. font.fg_size
                        .. "'>"
                        .. label_correct[key].label
                        .. "</span>"
                    )
        ...
        label_correct.main:set_markup(
            "<span foreground='"
            .. theme.label_fg
            .. "' size='"
            .. font.welcome_size
            .. "'>"
            .. label_correct.main.label
            .. "</span>"
        )
    ...
    if question.label_incorrect ~= nil then
        ...
        for key, value in pairs(question.label_incorrect) do
            ...
            if type(key) == "number" then
                ...
                if value ~= nil then
                    ...
                    label_incorrect[key]:set_markup(
                        "<span foreground='"
                        .. theme.label_incorrect
                        .. "' size='"
                        .. font.fg_size
                        .. "'>"
                        .. label_incorrect[key].label
                        .. "</span>"
                    )
        ...
        label_incorrect.main:set_markup(
            "<span foreground='"
            .. theme.label_fg
            .. "' size='"
            .. font.welcome_size
            .. "'>"
            .. label_incorrect.main.label
            .. "</span>"
        )
