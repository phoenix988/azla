...
local function buttonYesAction(currentQuestion, switchQuestion, question,
                               prevButton,submitButton,w,wg,bt)
...
function M.are_you_sure(currentQuestion, switchQuestion, question,
    ...
    function app:on_activate()
        ...
        style.set_theme(label,{{color = theme.label_fg,
        ...
        function buttonYes:on_clicked()
             ...
             qurrentQuestion = buttonYesAction(currentQuestion, switchQuestion, question,
                                               prevButton,submitButton,w,wg,bt)
